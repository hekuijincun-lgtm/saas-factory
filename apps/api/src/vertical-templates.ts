...
export const VERTICAL_TEMPLATES: Record<string, VerticalTemplate> = {
  ...
  gym: {
    menus: [
      { name: '月額会員', duration: 0, price: 8800, description: '月額制フィットネス会員', category: '月額' },
      { name: '10回券', duration: 0, price: 15000, description: '好きなタイミングで使える10回分の回数券', category: '回数券' },
      { name: '体験', duration: 60, price: 1500, description: '初めての方向け体験トレーニング', category: '体験' },
      { name: 'パーソナルトレーニング', duration: 60, price: 6000, description: 'トレーナーとマンツーマンの個別指導', category: 'パーソナル' },
      { name: 'グループレッスン', duration: 60, price: 2000, description: 'ヨガ・ピラティス等のグループレッスン', category: 'グループ' },
      { name: 'ストレッチ', duration: 30, price: 3500, description: 'トレーナーによるストレッチ指導', category: 'ストレッチ' },
    ],
    staff: [
      { name: 'トレーナーA', role: 'トレーナー' },
      { name: 'トレーナーB', role: 'トレーナー' },
    ],
    faq: [
      {
        question: '入会に必要なものはありますか？',
        answer: '身分証明書（運転免許証・保険証など）と、口座引き落としまたはクレジットカードをご用意ください。体験当日のご入会で入会金が割引になるキャンペーンも実施中です。',
      },
      {
        question: 'マシンの使い方がわからなくても大丈夫ですか？',
        answer: 'ご安心ください。初回オリエンテーションでマシンの使い方を丁寧にご説明いたします。いつでもスタッフにお声がけいただければ、フォームの確認や使い方のサポートをいたします。',
      },
      {
        question: 'パーソナルトレーニングはどんな内容ですか？',
        answer: 'お客様の目標（ダイエット・筋力アップ・姿勢改善など）に合わせたオーダーメイドのトレーニングプランを作成します。トレーナーがマンツーマンで指導しますので、効率的に結果を出すことができます。',
      },
      {
        question: '見学や体験はできますか？',
        answer: '見学は営業時間内いつでも可能です。体験トレーニングは1,500円で、施設利用とマシン説明を含む60分のプログラムです。運動しやすい服装と室内シューズをお持ちください。',
      },
      {
        question: '休会や退会の手続きはどうすればいいですか？',
        answer: '休会・退会のお手続きは、前月の15日までにフロントまたはLINEからお申し出ください。休会中は月額会費の半額で在籍を維持でき、再開時はスムーズに復帰いただけます。',
      },
    ],
    aiCharacter: 'あなたはジム・フィットネスクラブの明るく元気な受付AIアシスタントです。会員様のフィットネス目標を応援し、適切なプランやレッスンのご案内を行ってください。運動初心者にも安心感を与える親しみやすい対応を心がけてください。',
    businessHours: { openTime: '07:00', closeTime: '22:00' },
    closedWeekdays: [],
    verticalConfig: {
      surveyEnabled: true,
      surveyQuestions: [
        { id: 'fitness_goal', label: 'フィットネスの目標を教えてください（ダイエット・筋力アップ・健康維持など）', type: 'text', enabled: true },
        { id: 'experience_level', label: '運動経験・頻度を教えてください', type: 'text', enabled: true },
      ],
    },
  },
  ...
  school: {
    menus: [
      { name: '月謝', duration: 0, price: 12000, description: '月額制レッスン受講料', category: '月謝' },
      { name: '4回券', duration: 0, price: 10000, description: '4回分のレッスンチケット', category: '回数券' },
      { name: '体験レッスン', duration: 60, price: 1000, description: '初めての方向け体験レッスン', category: '体験' },
      { name: '集中コース', duration: 120, price: 25000, description: '短期間で集中的に学べるコース', category: '集中' },
      { name: '教材費', duration: 0, price: 3000, description: 'テキスト・教材の費用', category: '教材' },
      { name: '発表会参加費', duration: 0, price: 5000, description: '発表会・コンサートへの参加費用', category: 'イベント' },
    ],
    staff: [
      { name: '講師A', role: '講師' },
      { name: '講師B', role: '講師' },
    ...
    faq: [
      {
        question: '体験レッスンはどのような内容ですか？',
        answer: '体験レッスンでは、実際のクラスに参加いただき、レッスンの雰囲気や指導内容を体感していただけます。レベルに合わせた内容で進めますので、初心者の方もご安心ください。レッスン後にコースのご説明もいたします。',
      },
      {
        question: 'レッスンの振替はできますか？',
        answer: 'レッスン前日の18時までにご連絡いただければ、同月内での振替が可能です。LINEから簡単にお手続きいただけます。月謝制の場合は月2回まで、回数券の場合は有効期限内で自由に日程を選べます。',
      },
      {
        question: '進捗はどのように確認できますか？',
        answer: '定期的な進捗レポートをLINEでお送りしています。また、講師が毎回のレッスン内容と成果を記録しておりますので、管理画面からいつでも確認いただけます。年に2回の個別面談で詳しいフィードバックも行っています。',
      },
      {
        question: '何歳から受講できますか？',
        answer: 'コースにより異なりますが、お子様向けクラスは4歳から、大人向けクラスは年齢制限なくご参加いただけます。シニア向けのゆったりクラスもございますので、お気軽にお問い合わせください。',
      },
      {
        question: '発表会は必ず参加しなければなりませんか？',
        answer: '発表会への参加は任意です。ただし、目標に向かって練習することで上達が早まるため、積極的な参加をおすすめしています。観覧のみの参加も可能ですので、まずは雰囲気を見ていただくのも良いかと思います。',
      },
    ],
    aiCharacter: 'あなたは習い事・スクールの丁寧で知的な受付AIアシスタントです。生徒様や保護者様の学習目標に寄り添い、最適なコースやレッスンをご案内してください。学ぶ楽しさを伝え、初めての方にも安心感を持っていただける対応を心がけてください。',
    businessHours: { openTime: '10:00', closeTime: '21:00' },
    closedWeekdays: [0],
    verticalConfig: {
      surveyEnabled: true,
      surveyQuestions: [
        { id: 'learning_goal', label: '学習の目標を教えてください', type: 'text', enabled: true },
        { id: 'experience_level', label: '経験レベルを教えてください（初心者・経験者など）', type: 'text', enabled: true },
        { id: 'preferred_schedule', label: 'ご希望の曜日・時間帯はありますか？', type: 'text', enabled: true },
      ],
    },
  },
